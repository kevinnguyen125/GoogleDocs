            ...
            <form style={{ height: '2.5em' }}>
              <FormControl style={styles.formControl}>
                ...
                >
                  ...
                  <MenuItem value={28} onMouseDown={this.props.clickHandlers.fontSize}>28</MenuItem>
                  <MenuItem value={32} onMouseDown={this.props.clickHandlers.fontSize}>32</MenuItem>
                  <MenuItem value={36} onMouseDown={this.props.clickHandlers.fontSize}>36</MenuItem>
                  <MenuItem value={40} onMouseDown={this.props.clickHandlers.fontSize}>40</MenuItem>
                </Select>
              </FormControl>
            </form>
          </ListItem>
